      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10 spacing-modern">
        ...
        <div className="lg:hidden mb-6 space-y-3">
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="flex items-center justify-center gap-3 px-4 py-3 bg-gradient-to-r from-blue-400 via-purple-500 to-blue-600 border border-blue-500/30 rounded-soft text-white hover:from-blue-500 hover:via-purple-600 hover:to-blue-700 transition-all duration-200 cursor-pointer text-sm"
          >
            <Image 
              src="/kakobuy-logo.png" 
              alt="Kakobuy Logo" 
